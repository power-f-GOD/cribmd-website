...
const Header = (): JSX.Element => {
  ...
  return (
    ...
    experiences that addresses the challenges of accessing medical health."
      bodyText="We do this by offering low cost medical services from online to door-step outreach.">
      <RevealOnScroll component={Row} className="justify-content-center my-5" data-anim_delay="0.9">
        <Col className="my-3 px-3" xs={6} md={3} data-anim_delay="0.1">
          <Box as="h2">$5K+</Box>
          <Box as="h6">Certified Doctors</Box>
          <Box className="tertiary-content">and Health Practitioners across all medical fields</Box>
        </Col>
        <Col className="my-3 px-3" xs={6} md={3} data-anim_delay="0.2">
          <Box as="h2">$17k+</Box>
          <Box as="h6">Active Users</Box>
          <Box className="tertiary-content">have been onboarded and also successfully treated</Box>
        </Col>
        ...
        <Col className="my-3 px-3" xs={6} md={3} data-anim_delay="0.4">
          <Box as="h2">3000+</Box>
          <Box as="h6"> Homes</Box>
          <Box className="tertiary-content">visited across the globe since the initial launch</Box>
        </Col>
      </RevealOnScroll>
    </PageHeader>
